...
from Physics.Force import Force, CREATEFORCE, NONE, CONSTANTFORCE, EARTHGRAVITY, SQUARELAW, CUBELAW, GRAVITATIONALFORCE, ELECTRICFORCE, MAGNETICFORCE
...
class Proton(Particle):
    def __init__(self, coordinateSystem = None, position_vector = Vector(2,[0,0]), velocity = Vector(2,[0,0])):
        ...
        self.mass = float(1.67262e-27)
        self.charge = float(1.60217662e-19)
